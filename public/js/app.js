...
socket.on("notification-channel:App\\Events\\NotifyUser", function (message) {
  ...
  if (recepient_id == app.authUser.id) {
    ...
    new Noty({
      ...
      layout: 'topRight',
      theme: 'mint',
      text: '<a href="' + url + '"><div class="col-sm-3 padding-lr-0 paddint-top-0">' + '<div class="thumbnail"><img src="' + thumbnail + '" class="img-responsive user-photo classe"></div>' + '</div> ' + '<div class="col-sm-9"> ' + '<div class="pull-left">' + ' <span class="white">From: <b>' + name + '</b></span><br>' + ' <span class="white"><b>' + action + '</b></span>' + ' <span class="date white row">Posted : ' + created_at + '</span>' + '</div><div class="clr"></div>' + '</div>' + '</a>',
      timeout: 50000,
      progressBar: true,
