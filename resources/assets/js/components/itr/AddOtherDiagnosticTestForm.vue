<template>
    ...
    <div class="modal" id="add-other-diagnostic-test-form" tabindex="-1" role="dialog" aria-labelledby="add-other-diagnostic-test-form" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title custom_align" id="Heading">Other Diagnostic Test</h4>
      </div>
