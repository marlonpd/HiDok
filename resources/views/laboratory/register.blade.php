...
@section('content')
   <div class="row">
    <div class="col-sm-4 col-sm-offset-4">
      <h2>Please sign up | {{Config::get('constants.account_type_label.laboratory') }}</h2>

      <form method="post" action="{{ url('/laboratory/register') }}">
        {!! csrf_field() !!}

        <input type="hidden" name="account_type" id="account_type" value="{{ Config::get('constants.account_type.laboratory') }}">
