                    ...
                    <div class="post-detail">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="row">
                                ...
                                <div>
                                    <span class="date">Posted @{{ post.created_at | formatDate}}</span><div class="pull-right"><span class="label">alice</span> <span class="label">story</span> <span class="label">blog</span> <span class="label">personal</span></div>
                                </div> 
